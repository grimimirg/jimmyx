...
import com.test.app.security.condition.UserSecurityCheckCondition;
...
public class UserController {
	...
	public @SerializeJson void get(@ParamQuery(value = "p1") @SecureGenericCheck String p1,
			@ParamQuery(value = "p2") Integer p2, @ParamQuery(value = "p3") String p3,
			@ParamBody @SecureConditionCheck(condition = UserSecurityCheckCondition.class) User user) {
